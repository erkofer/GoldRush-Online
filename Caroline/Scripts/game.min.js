...
(function(a){function p(){a.activeWindow&&a.activeWindow.hide();a.activeWindow=null}function h(){if(a.activeWindow){var f=a.activeWindow.container.getBoundingClientRect();a.activeWindow.container.style.left=window.innerWidth/2-(f.right-f.left)/2+"px";a.activeWindow.container.style.top=window.innerHeight/2-(f.bottom-f.top)/2+"px"}else clearInterval(a.intervalIdentifier)}var g=0,m;a.activeWindow;a.intervalIdentifier;a.hide=p;a.close=function(){if(a.activeWindow){var f=a.activeWindow;p();f.container.parentNode.removeChild(f.container)}};
...
(function(a){var p=[],h=function(){return function(){this.quantity=0}}();a.register=function(a,m){if(!p[a]){var l=new h;l.name=m;p[a]=l}};a.lookupName=function(a){return p[a].name};a.setQuantity=function(a,h){p[a].quantity=h};a.getQuantity=function(a){return p[a].quantity};a.setLifeTimeTotal=function(a,h){p[a].lifeTimeTotal=h};a.getLifeTimeTotal=function(a){return p[a].lifeTimeTotal}})(Objects||(Objects={}));var Account;
(function(a){function p(){d.classList.contains("closed")||d.classList.add("closed")}function h(){var a=new modal.Window,b=document.createElement("DIV");b.style.width="400px";var d=document.createElement("DIV");d.style.marginBottom="5px";var c=document.createElement("INPUT");c.type="TEXT";c.maxLength=16;c.placeholder="Username";d.appendChild(c);var n=document.createElement("DIV");n.style.marginBottom="5px";var q=document.createElement("INPUT");q.type="PASSWORD";q.pattern=".{6,}";q.placeholder="Password";
n.appendChild(q);var f=document.createElement("DIV");f.style.marginBottom="5px";var h=document.createElement("INPUT");h.type="CHECKBOX";h.placeholder="Stay logged in on this computer?";f.appendChild(h);b.appendChild(d);b.appendChild(n);b.appendChild(f);e=document.createElement("div");a.addElement(e);a.title="Log in";a.addElement(b);a.addNegativeOption("Cancel").addEventListener("click",function(){modal.close()},!1);a.addAffirmativeOption("Submit").addEventListener("click",function(){for(l(c.value,
...
f.style.marginBottom="5px";var h=document.createElement("INPUT");h.type="PASSWORD";h.pattern=".{6,}";h.placeholder="Password";f.appendChild(h);var u=document.createElement("DIV");u.style.marginBottom="5px";var y=document.createElement("INPUT");y.type="PASSWORD";y.pattern=".{6,}";y.placeholder="Confirm password";u.appendChild(y);y.onblur=function(){h.value!=y.value&&y.setCustomValidity("Passwords are not the same.")};y.onfocus=function(){y.setCustomValidity("")};b.appendChild(d);b.appendChild(e);b.appendChild(f);
b.appendChild(u);a.addElement(b);n=document.createElement("div");a.addElement(n);a.title="Register";a.addNegativeOption("Cancel").addEventListener("click",function(){modal.close()},!1);a.addAffirmativeOption("Submit").addEventListener("click",function(){for(m(q.value,c.value,h.value,y.value);n.firstChild;)n.removeChild(n.firstChild)},!1);a.show()}function m(a,b,c,d){$.ajax({type:"POST",url:"/Api/Account/Register",data:$.param({Email:a,UserName:b,Password:c,ConfirmPassword:d}),headers:{"Content-Type":"application/x-www-form-urlencoded"},
success:function(a){a=JSON.parse(a);if(a.Succeeded)Connection.restart(),k(),modal.close();else{for(;n.firstChild;)n.removeChild(n.firstChild);for(var b=0;b<a.Errors.length;b++){var c=document.createElement("div");c.textContent=a.Errors[b];n.appendChild(c)}}}})}function l(a,b,c){$.ajax({type:"POST",url:"/Api/Account/Login",data:$.param({UserName:a,Password:b,RememberMe:c}),headers:{"Content-Type":"application/x-www-form-urlencoded"},success:function(a){a=JSON.parse(a);if(a.Succeeded)Connection.restart(),
...
headers:{"Content-Type":"application/x-www-form-urlencoded"},success:function(a){a=JSON.parse(a);c.succeeded(a)},failure:function(a){c.failed(a)}})};return a}();(function(){d=document.createElement("DIV");d.classList.add("account-manager");d.classList.add("closed");d.onmouseenter=function(){clearTimeout(r)};d.onmouseleave=function(){r=setTimeout(p,250)};var a=document.createElement("DIV");a.textContent="Sign in";a.classList.add("account-option");a.classList.add("anonymous-account-option");a.addEventListener("click",
...
b.style.width="400px";b.textContent="Loading...";a.addElement(b);var c=new t;c.resultsElement=b;c.sendRequest(0,19);a.show()});document.getElementsByClassName("header-links")[0].appendChild(a);k()})();a.info=k})(Account||(Account={}));var Rock;
(function(a){function p(a,b){var c=a.getBoundingClientRect();return{x:b.clientX-c.left,y:b.clientY-c.top}}function h(b,c){if(b>e&&b<e+64&&c>r&&c<r+64){if(w){m(e+2,r+2,60,60);if(v)for(var d=Utils.getRandomInt(1,3),n=0;n<d;n++){var f=Utils.getRandomInt(-5,5),s=Utils.getRandomInt(-2,2);a.particles.push(new z(b+f,c+s))}v=!1}else m(e-2,r-2,68,68),v=!0;t=!0}else t&&(m(e,r,64,64),t=!1,v=!0)}function g(a,b){a!=e&&b!=r&&(e=a,r=b,n?m(a,b,64,64):setTimeout(function(){g(a,b)},10))}function m(a,d,n,e){k.clearRect(0,
0,250,250);k.drawImage(b,0,0);k.drawImage(c,a,d,n,e)}var l=document.getElementById("rock"),f=document.getElementById("particles"),k=l.getContext("2d"),d=f.getContext("2d"),b=new Image,c=new Image(16,16),n=!1,e=0,r=0,t=!1,w=!1;a.particles=[];var z=function(){function a(b,c){this.height=this.width=5;this.dispose=!1;this.x=b;this.y=c;this.verticalVelocity=Utils.getRandomInt(-100,-155);this.horizonalVelocity=Utils.getRandomInt(-50,50);this.width=Utils.getRandomInt(3,6);this.height=Utils.getRandomInt(3,
6);this.rotation=Utils.getRandomInt(0,180);this.rotationalVelocity=Utils.getRandomInt(-75,75);this.lastTick=Date.now()}a.prototype.update=function(){var a=Date.now()-this.lastTick;this.lastTick=Date.now();a/=1E3;this.rotation+=this.rotationalVelocity*a;this.y+=this.verticalVelocity*a;this.x+=this.horizonalVelocity*a;this.verticalVelocity+=200*a;270<this.y&&(this.dispose=!0)};return a}();a.Particle=z;var v=!0;a.moveRock=g;var s=document.createElement("canvas"),x=s.getContext("2d");setInterval(function(){d.clearRect(0,
0,250,250);for(var b=0;b<a.particles.length;b++){var c=a.particles[b];c.update();var n=c;s.width=n.width;s.height=n.height;x.rect(0,0,n.width,n.height);x.fillStyle="gray";x.fill();x.stroke();d.beginPath();var e=d,f=s,h=n.x,g=n.y,k=n.width,B=n.height,n=n.rotation*Math.PI/180;e.translate(h+k/2,g+B/2);e.rotate(n);e.drawImage(f,k/2*-1,B/2*-1,k,B);e.rotate(-1*n);e.translate(-1*(h+k/2),-1*(g+B/2));c.dispose&&a.particles.splice(b,1)}},10);(function(){b.onload=function(){k.drawImage(b,0,0);console.log("rock loaded")};
b.src="/Content/Rock.png";c.onload=function(){n=!0};c.src="/Content/Stone.png";l.addEventListener("mousemove",function(a){a=p(l,a);h(a.x,a.y)},!1);l.addEventListener("mousedown",function(a){a=p(l,a);w=!0;h(a.x,a.y);Connection.mine(a.x,a.y)},!1);l.addEventListener("mouseup",function(a){a=p(l,a);w=!1;h(a.x,a.y)},!1);l.addEventListener("mouseleave",function(a){a=p(l,a);w=!1;h(a.x,a.y)},!1)})()})(Rock||(Rock={}));var Tabs;
(function(a){function p(){if(l){var d=l.scrollHeight;d>window.innerHeight-a.bottomPadding&&(d=window.innerHeight-a.bottomPadding);g.style.minHeight=d+"px";g.style.maxHeight=d+"px";g.style.overflowY=d>=window.innerHeight-a.bottomPadding?"scroll":"hidden"}}var h=0,g=document.getElementById("paneContainer");a.bottomPadding=200;var m=[],l,f=new (function(){function d(a){this.container=a;this.tabs=[];this.lowestId=0;this.id=h++;m.push(this)}d.prototype.newTab=function(b){var c=new k;c.pane=b;b=document.createElement("DIV");
...
a.registerGameTab=function(a,b){var c=f.newTab(a);b&&f.css(c,b)};a.updateGameTabs=p;Utils.addEvent(window,"resize",a.updateGameTabs);setInterval(p,20);a.activateTab=function(a,b){m[a].activate(b);p()};var k=function(){function a(){}a.prototype.deactivate=function(){Utils.cssSwap(this.button,"active","inactive");this.pane.style.display="none";this.pane.style.overflow="hidden"};a.prototype.activate=function(){Utils.cssSwap(this.button,"inactive","active");this.pane.style.display="block";this.pane.style.overflow=
"visible";l=this.pane};return a}()})(Tabs||(Tabs={}));var Chat;
(function(a){function p(){if(!g){g=document.createElement("DIV");g.classList.add("chat-window");g.classList.add("social");g.id="chatWindow";g.style.backgroundColor="#ebebeb";g.style.border="1px solid #adadad";var a=document.createElement("DIV");a.classList.add("chat-header");a.style.backgroundColor="rgb(160, 160, 160)";g.appendChild(a);var k=document.createElement("DIV");k.textContent="_";k.style.position="absolute";k.style.top="0";k.style.right="0";k.addEventListener("click",function(){g.classList.contains("closed")?
...
""}var g,m,l;a.initialize=p;p();a.log=function(a){var h=document.getElementById("debuglog"),d=document.createElement("DIV");d.textContent=a;h.appendChild(d)};a.receiveGlobalMessage=function(a,h,d,b){var c=document.getElementById("chatlog"),n=5>Math.abs(c.scrollTop-(c.scrollHeight-c.offsetHeight)),e=document.createElement("DIV");e.classList.add("chat-msg");b&&""!=b&&e.classList.add("chat-"+b);b=document.createElement("SPAN");b.textContent="["+Utils.convertServerTimeToLocal(d)+"] ";d=document.createElement("SPAN");
d.textContent=a;d.classList.add("chat-sender");a=document.createElement("SPAN");a.textContent=h;a.classList.add("chat-text");h=document.createElement("SPAN");h.textContent=": ";e.appendChild(b);e.appendChild(d);e.appendChild(h);e.appendChild(a);c.appendChild(e);n&&(c.scrollTop=c.scrollHeight)}})(Chat||(Chat={}));var tooltip;
(function(a){function p(a,b){var c=d.getBoundingClientRect(),n=c.right-c.left,c=c.bottom-c.top;d.style.left=n+(a+15)>window.innerWidth?a-n-15+"px":a+15+"px";d.style.top=0<b-c?b-c+"px":b+5+"px"}function h(){d&&d.parentElement.removeChild(d);k=d=null}function g(a,b,c){var d=new t;m(a);c&&(d.header=c);d.content=b;f.push(d);a.dataset?a.dataset.tooltip=l:a.setAttribute("data-tooltip",l.toString());l++}function m(a){a.onmouseenter=function(a){var g=+a.target.getAttribute("data-tooltip");r!==a.target&&(b=
setInterval(function(){c+=.01;if(.25<=c){var a=n,x=e,q=f[g];k!==g&&h();k=g;d=q.html;document.body.appendChild(d);p(a,x);c=0;clearInterval(b);b=null}},10));r=a.target};a.onmousemove=function(a){a=a.pageX||a.pageY?{x:a.pageX,y:a.pageY}:a.clientX||a.clientY?{x:a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,y:a.clientY+document.body.scrollTop+document.documentElement.scrollTop}:void 0;b||p(a.x,a.y);n=a.x;e=a.y};a.onmouseleave=function(a){r=null;clearInterval(b);c=0;h()}}var l=
0,f=[],k,d,b,c=0,n,e,r,t=function(){function a(){this.html=document.createElement("div");this.html.classList.add("tooltip-wrapper")}Object.defineProperty(a.prototype,"header",{get:function(){return this.html.getElementsByClassName("tooltip-header")[0]},set:function(a){a.classList.add("tooltip-header");this.html.appendChild(a)},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"content",{get:function(){return this.html.getElementsByClassName("tooltip-content")[0]},set:function(a){a.classList.add("tooltip-content");
...
(function(a){function p(a){Connection.sellItem(c.id,a?a:1)}function h(){var b=document.getElementById("selecteditemquantity"),c=+b.value;Utils.isNumber(c)&&c>a.getSelectedItemQuantity()&&(b.value=a.getSelectedItemQuantity().toString())}function g(){f=document.createElement("DIV");document.getElementById("paneContainer").appendChild(f);d=document.createElement("DIV");d.classList.add("selected-item");d.style.display="none";var s=document.createElement("SPAN");s.textContent="x";s.style.top="0px";s.style.right=
...
e.appendChild(s);q=s.createTHead();g=q.insertRow(0);q=q.insertRow(0);q.classList.add("table-header");q=q.insertCell(0);q.textContent="Inventory Configuration";q.setAttribute("colspan","10");g.classList.add("table-subheader");for(var m in v)0<=parseInt(m,10)&&"NFS"!=v[m]&&(g.insertCell(g.cells.length).classList.add("config-cell-check"),q=g.insertCell(g.cells.length),q.classList.add("config-cell-name"),q.textContent=v[m]);n=s.createTBody();k=document.createElement("DIV");k.style.position="relative";
...
var e=document.createElement("DIV");e.style.verticalAlign="top";e.style.display="inline-block";e.textContent=Utils.formatNumber(b.worth);b.worthElm=e;var f=document.createElement("DIV");f.classList.add("Quarter-Coins");f.style.display="inline-block";d.appendChild(f);d.appendChild(e);c.appendChild(d);e=document.createElement("DIV");e.style.width="64px";e.style.height="64px";e.style.position="relative";e.style.margin="0 auto";d=document.createElement("DIV");d.classList.add(b.name.replace(" ","_"));
e.appendChild(d);c.appendChild(e);d=document.createElement("DIV");b.quantityElm=d;d.classList.add("item-text");d.textContent=Utils.formatNumber(0);c.appendChild(d);if(null!=b.category){var u,h,e=n.rows.length,d=b.category,d=2*d;d--;for(f=0;f<e;f++){var g=n.rows[f].cells[d];if(g&&0==g.childElementCount){u=n.rows[f].cells[d];h=n.rows[f].cells[d-1];break}}if(!u){h=n.insertRow(n.rows.length);h.classList.add("table-row");for(var k in v)0<=parseInt(k,10)&&"NFS"!=v[k]&&(h.insertCell(h.cells.length).classList.add("config-cell-check"),
h.insertCell(h.cells.length).classList.add("config-cell-name"));u=h.cells[d];h=h.cells[d-1]}k=document.createElement("DIV");k.classList.add("item-text");k.style.height="auto";e=document.createElement("SPAN");e.style.verticalAlign="top";d=document.createElement("DIV");d.classList.add("Third-"+Utils.cssifyName(b.name));d.style.display="inline-block";w[b.id]=d;e.textContent=b.name;t[b.id]=e;k.appendChild(d);k.appendChild(e);u.appendChild(k);u=document.createElement("INPUT");u.type="CHECKBOX";var D=b.id;
a.configClickers[D]=u;u.addEventListener("change",function(b){Connection.configureItem(D,a.configClickers[D].checked)});h.appendChild(u)}return c}a.items=[];a.configClickers=[];var f,k,d,b,c,n,e,r,t=[],w=[],z=function(){return function(a,b,c,d){this.id=a;this.name=b;this.worth=c;this.category=d}}();a.Item=z;(function(a){a[a.NFS=0]="NFS";a[a.ORE=1]="ORE";a[a.GEM=2]="GEM";a[a.INGREDIENT=3]="INGREDIENT";a[a.CRAFTING=4]="CRAFTING";a[a.POTION=5]="POTION"})(a.Category||(a.Category={}));var v=a.Category;
a.getSelectedItemQuantity=function(){return c?c.quantity:0};a.selectItem=function(e){e?(null!=c&&b.classList.remove(Utils.cssifyName(c.name)),c=a.items[e],b.classList.add(Utils.cssifyName(c.name)),r.style.display=5==c.category?"inline-block":"none",h()):(b.classList.remove(Utils.cssifyName(c.name)),c=null);d.style.display=null==c?"none":"block"};a.sellSelectedItem=p;a.sellAllSelectedItem=function(){p(c.quantity)};a.modifyConfig=function(b,c){a.configClickers[b]||console.log(b);a.configClickers[b].checked=
...
c){Utils.ifNotDefault(c,function(){Objects.setQuantity(b,c);Crafting.update();a.items[b].quantityElm.textContent=Utils.formatNumber(c);a.items[b].quantity=c;a.items[b].container.style.display=0!=a.items[b].category&&null!=a.items[b].category?0==c?"none":"inline-block":0==Objects.getLifeTimeTotal(b)?"none":"inline-block";h()})};a.update=function(){0>=t.length||a.items.forEach(function(a){var b=Objects.getLifeTimeTotal(a.id);t[a.id]&&(t[a.id].textContent=0<b?a.name:"???");w[a.id]&&(w[a.id].style.display=
0<b?"inline-block":"none")})}})(Inventory||(Inventory={}));var Connection;
(function(a){function p(){console.log("Connection opened");var a=d.encode64();h(a);d=new Komodo.ClientActions;m=setInterval(function(){var a=d.encode64();h(a);d=new Komodo.ClientActions},1E3)}function h(a){if(a.encode64){var c=a.encode64();Chat.log("Sent "+g(c)+" bytes to komodo.");Chat.log("Decoded: ");Chat.log(JSON.stringify(a));Chat.log("Encoded: ");Chat.log(a.encode64());Komodo.send(a.encode64())}else Chat.log("Sent "+g(a)+" bytes to komodo."),Komodo.send(a)}function g(a){var c=[];a=[a];for(var d=
...
Store.addItem(e.Id,e.Category,e.Price,e.Factor,e.Name,e.MaxQuantity);if(c.Processors)for(d=0;d<c.Processors.length;d++){e=c.Processors[d];Crafting.addProcessor(e.Id,e.Name);for(var f=0;f<e.Recipes.length;f++)Crafting.addProcessorRecipe(e.Id,e.Recipes[f].Ingredients,e.Recipes[f].Resultants)}if(c.CraftingItems)for(d=0;d<c.CraftingItems.length;d++)e=c.CraftingItems[d],Crafting.addRecipe(e.Id,e.Ingredients,e.Resultants,e.IsItem);if(c.Buffs)for(d=0;d<c.Buffs.length;d++)e=c.Buffs[d],Buffs.register(e.Id,
...
d=0;d<c.length;d++)Inventory.modifyConfig(c[d].Id,c[d].Enabled);if(null!=a.Processors)for(c=a.Processors,d=0;d<c.length;d++)e=c[d],Crafting.updateProcessor(e.Id,e.SelectedRecipe,e.OperationDuration,e.CompletedOperations,e.TotalOperations,e.Capacity);null!=a.AntiCheatCoordinates&&(c=a.AntiCheatCoordinates,Rock.moveRock(c.X,c.Y));if(null!=a.Buffs)for(c=a.Buffs,d=0;d<c.length;d++)e=c[d],Buffs.update(e.Id,e.TimeActive);null!=a.IsRateLimited&&(k.style.display=a.IsRateLimited?"block":"none")});a.restart=
function(){Komodo.restart()};var d=new Komodo.ClientActions;Komodo.connection.stateChanged(function(a){a.newState===$.signalR.connectionState.connected&&(p(),f.style.display="none");a.newState===$.signalR.connectionState.disconnected&&(clearInterval(m),f.style.display="block");a.newState===$.signalR.connectionState.reconnecting&&(f.style.display="block")});a.drink=function(a){var c=new Komodo.ClientActions.PotionAction;c.Id=a;d.PotionActions.push(c)};a.mine=function(a,c){var f=new Komodo.ClientActions.MiningAction;
f.X=a;f.Y=c;d.MiningActions.push(f)};a.sellItem=function(a,c){var f=new Komodo.ClientActions.InventoryAction,e=new Komodo.ClientActions.InventoryAction.SellAction;e.Id=a;e.Quantity=c;f.Sell=e;d.InventoryActions.push(f)};a.configureItem=function(a,c){var f=new Komodo.ClientActions.InventoryAction,e=new Komodo.ClientActions.InventoryAction.ConfigAction;e.Id=a;e.Enabled=c;f.Config=e;d.InventoryActions.push(f)};a.purchaseItem=function(a,c){var f=new Komodo.ClientActions.StoreAction,e=new Komodo.ClientActions.StoreAction.PurchaseAction;
e.Id=a;e.Quantity=c?c:1;f.Purchase=e;d.StoreActions.push(f)};a.sellAllItems=function(){var a=new Komodo.ClientActions.InventoryAction;a.SellAll=!0;d.InventoryActions.push(a)};a.craftRecipe=function(a,c){var f=new Komodo.ClientActions.CraftingAction;f.Id=a;f.Quantity=c;d.CraftingActions.push(f)};a.processRecipe=function(a,c,f){var e=new Komodo.ClientActions.ProcessingAction;e.Id=a;e.RecipeIndex=c;e.Iterations=f;d.ProcessingActions.push(e)};a.sendGlobalMessage=function(a){var c=new Komodo.ClientActions.SocialAction,
f=new Komodo.ClientActions.SocialAction.ChatAction;f.GlobalMessage=a;c.Chat=f;d.SocialActions.push(c)};a.send=h})(Connection||(Connection={}));var Buffs;
(function(a){var p=[],h=document.getElementById("sidebarInformation"),g,m=function(){return function(){}}();a.register=function(a,f,h,d){if(!p[a]){var b=new m;b.name=f;b.description=h;b.duration=d;p[a]=b;a=document.createElement("div");a.classList.add("buff-container");tooltip.create(a,b.description);f=document.createElement("div");f.textContent=b.name;f.classList.add("buff-header");a.appendChild(f);f=document.createElement("div");f.classList.add("buff-image-container");a.appendChild(f);h=document.createElement("div");
h.classList.add(Utils.cssifyName(b.name));f.appendChild(h);f=document.createElement("div");f.classList.add("buff-header");a.appendChild(f);g.appendChild(a);b.container=a;b.durationElm=f}};a.update=function(a,f){var h=p[a];h.timeActive=f;h.durationElm.textContent="("+Utils.formatTime(h.duration-f)+")";h.container.style.display=0==f?"none":"inline-block"};g=document.createElement("div");h.appendChild(g)})(Buffs||(Buffs={}));var Store;
(function(a){function p(){g=document.createElement("div");document.getElementById("paneContainer").appendChild(g);Tabs.registerGameTab(g,"Store");for(var a in f)if(0<=parseInt(a,10)){var b=f[a];if("CRAFTING"!=b){var c=document.createElement("div");c.classList.add("store-category");l[b]=c;var h=document.createElement("div");h.textContent=b;h.classList.add("store-category-header");c.appendChild(h);g.appendChild(c)}}}function h(a){var b=document.createElement("div");b.classList.add("store-item");a.container=
b;var c=document.createElement("div");c.classList.add("store-item-header");var f=document.createElement("div");f.classList.add("store-item-header-text");f.textContent=a.name;c.appendChild(f);var e=document.createElement("div");e.classList.add("store-item-header-quantity-container");var h=document.createElement("span");h.classList.add("store-item-header-quantity");var g=document.createElement("span");g.classList.add("store-item-header-quantity");var k=document.createElement("span");k.classList.add("store-item-header-quantity");
k.textContent="/";1<a.maxQuantity&&(e.appendChild(g),e.appendChild(k),e.appendChild(h));c.appendChild(e);a.maxQuantityElm=h;a.quantityElm=g;a.nameElm=f;b.appendChild(c);c=document.createElement("DIV");c.style.width="64px";c.style.height="64px";c.style.position="relative";c.style.margin="0 auto";f=document.createElement("DIV");f.classList.add(Utils.cssifyName(a.name));c.appendChild(f);b.appendChild(c);c=document.createElement("div");c.classList.add("store-item-footer");f=document.createElement("div");
f.classList.add("item-text");e=document.createElement("div");e.textContent=Utils.formatNumber(a.price);e.style.display="inline-block";e.style.verticalAlign="top";a.priceElm=e;h=document.createElement("div");h.classList.add("Quarter-Coins");h.style.display="inline-block";f.appendChild(h);f.appendChild(e);var e=document.createElement("div"),h=Utils.createButton("Buy",""),m=a.id;if(5!=a.category)h.addEventListener("click",function(){Connection.purchaseItem(m)});else{var l=document.createElement("INPUT");
l.type="TEXT";l.style.width="40px";l.style.height="15px";e.appendChild(l);h.addEventListener("click",function(){Utils.isNumber(l.value)&&Connection.purchaseItem(m,+l.value)})}e.appendChild(h);c.appendChild(e);c.appendChild(f);b.appendChild(c);return b}var g,m=[],l=[];(function(a){a[a.MINING=1]="MINING";a[a.MACHINES=2]="MACHINES";a[a.GATHERING=3]="GATHERING";a[a.PROCESSING=4]="PROCESSING";a[a.ITEMS=5]="ITEMS";a[a.CRAFTING=6]="CRAFTING"})(a.Category||(a.Category={}));var f=a.Category,k=function(){return function(){}}();
a.tempFix=function(){p()};a.addItem=function(a,b,c,n,e,r){g||p();if(!m[a]){var t=new k;t.id=a;t.category=b;t.price=c;t.factor=n;t.name=e;t.maxQuantity=r?r:0;Objects.register(t.id,t.name);b=l[f[b]];null==b&&(b=l.MINING);6!=t.category&&b.appendChild(h(t));m[a]=t}};a.changeQuantity=function(a,b,c,f){var e=m[a];Utils.ifNotDefault(c,function(){if(0!=c)try{e.maxQuantity=c,e.maxQuantityElm.textContent=c.toString()}catch(a){}});Utils.ifNotDefault(b,function(){Objects.setQuantity(a,b);e.quantity=b;Crafting.update();
0!=c&&6!=e.category&&(e.container.style.display=-1>=e.quantity||e.quantity>=e.maxQuantity&&0<e.maxQuantity?"none":"inline-block",e.maxQuantity&&1<e.maxQuantity&&(e.quantityElm.textContent=b.toString()))});Utils.ifNotDefault(f,function(){e.priceElm&&(e.price=f,e.priceElm.textContent=Utils.formatNumber(f))})}})(Store||(Store={}));var Statistics;
...
for(a=0;a<c.length;a++){var g=h.insertCell(0);g.style.width=n[a];g.textContent=c[a];"0"!=e[a]&&(g.style.minWidth=e[a])}h=b.insertRow(2);h.classList.add("table-subheader");h=h.insertCell(0);h.colSpan=c.length;h.textContent="Items";h=b.insertRow(3);h.classList.add("table-subheader");h=h.insertCell(0);h.colSpan=c.length;h.textContent="Upgrades";d.appendChild(b)}function h(c,d){var b=a.processors[c];if(b){var e=b._recipes[d];for(b.selectedRecipe=d;b.recipeList.lastChild;)b.recipeList.removeChild(b.recipeList.lastChild);
...
for(b=0;b<r.length;b++){f=e.insertCell(0);f.style.width=n[b];f.style.height="75px";"0"!=w[b]&&(f.style.minWidth=w[b]);"Image"==r[b]&&(g=document.createElement("DIV"),g.classList.add(Utils.cssifyName(a.name)),g.style.margin="0 auto",f.appendChild(g));"Capacity"==r[b]&&(f.textContent="0",a.capacityElm=f);"Input"==r[b]&&(a.recipeList=f);if("Output"==r[b]){g=Utils.createButton("Max","");f.appendChild(g);g=document.createElement("INPUT");g.type="TEXT";g.style.width="35px";a.quantityTextbox=g;f.appendChild(g);
var p=a.id,q=document.createElement("SELECT");q.addEventListener("change",function(a){h(p,q.selectedIndex)});a.recipeSelector=q;f.appendChild(q)}"Action"==r[b]&&(g=Utils.createButton("Activate",""),g.addEventListener("click",function(){Utils.isNumber(a.quantityTextbox.value)&&Connection.processRecipe(a.id,a.recipeSelector.selectedIndex,+a.quantityTextbox.value)},!1),f.appendChild(g))}m(a);k.appendChild(d)}function m(a){x||(x=document.createElement("div"),s.appendChild(x));var b=document.createElement("div");
...
b.appendChild(c);c=document.createElement("div");c.classList.add("processor-sidebar-progress-bar-container");d=document.createElement("div");d.classList.add("processor-sidebar-progress-bar");a.sidebarJobBar=d;e=document.createElement("div");e.classList.add("processor-sidebar-progress-text");a.sidebarJobText=e;c.appendChild(e);c.appendChild(d);b.appendChild(c);b.style.display="none";x.appendChild(b)}function l(a,d){var h=b.rows.length;d&&(h=z,z++);h=b.insertRow(h);h.classList.add("table-row");a.row=
h;for(var f=0;f<c.length;f++){var g=h.insertCell(0);g.style.width=n[f];"0"!=e[f]&&(g.style.minWidth=e[f]);"Name"==c[f]&&(g.textContent=Objects.lookupName(a.id));if("Input"==c[f])for(var k=0;k<a.ingredients.length;k++){var l=document.createElement("DIV");l.classList.add("item-text");l.style.height="22px";var m=document.createElement("DIV");m.style.display="inline-block";var p=document.createElement("DIV");a.ingredients[k].quantityDiv=p;p.style.display="inline-block";p.style.verticalAlign="super";p.textContent=
Utils.formatNumber(a.ingredients[k].quantity);m.classList.add("Third-"+Utils.cssifyName(Objects.lookupName(a.ingredients[k].id)));l.appendChild(m);l.appendChild(p);g.appendChild(l)}if("Output"==c[f])for(k=0;k<a.resultants.length;k++)l=document.createElement("DIV"),l.classList.add("item-text"),l.style.height="22px",m=document.createElement("DIV"),m.style.display="inline-block",p=document.createElement("DIV"),p.style.display="inline-block",p.style.verticalAlign="super",p.textContent=Utils.formatNumber(a.resultants[k].quantity),
m.classList.add("Third-"+Utils.cssifyName(Objects.lookupName(a.resultants[k].id))),l.appendChild(m),a.isItem&&l.appendChild(p),g.appendChild(l);if("Action"==c[f]&&(k=Utils.createButton("Craft",""),k.addEventListener("click",function(){Connection.craftRecipe(a.id,1)},!1),g.appendChild(k),a.isItem)){var q=document.createElement("INPUT");q.type="TEXT";q.style.width="30px";k=Utils.createButton("Craft-x","");k.addEventListener("click",function(){Connection.craftRecipe(a.id,+q.value)},!1);g.appendChild(k);
g.appendChild(q)}}}var f,k,d,b,c=["Action","Description","Input","Output","Name"],n=["10%","50%","15%","15%","10%"],e=["170px","0","0","0","0"],r=["Action","Output","Input","Capacity","Image"],t=["10%","30%","20%","20%","20%"],w=["170px","0","0","0","0"],z=3,v=[];a.processors=[];var s=document.getElementById("sidebarInformation"),x,q=function(){function a(){this._recipes=[]}a.prototype.addRecipe=function(a){this._recipes.push(a);this.selectedRecipe||(this.selectedRecipe=0)};return a}();a.Processor=
q;var C=function(){function a(){this.ingredients=[];this.resultants=[]}a.prototype.addIngredient=function(a){this.ingredients.push(a)};a.prototype.addResultant=function(a){this.resultants.push(a)};return a}();a.Recipe=C;var A=function(){return function(a,b){this.id=a;this.quantity=b}}();a.Ingredient=A;a.addRecipe=function(a,b,c,d){f||p();if(!v[a]){var e=new C;e.id=a;e.isItem=d;v[a]=e;for(a=0;a<b.length;a++)e.addIngredient(new A(b[a].Id,b[a].Quantity));for(a=0;a<c.length;a++)e.addResultant(new A(c[a].Id,
c[a].Quantity));l(e,d)}};a.addProcessor=function(b,c){f||p();if(!a.processors[b]){var d=new q;d.id=b;d.name=c;a.processors[b]=d;g(d)}};a.addProcessorRecipe=function(b,c,d){if(a.processors[b]){var e=a.processors[b],f;a:if(a.processors[b]){f=a.processors[b];for(var g=0;g<f._recipes.length;g++)if(d[0].Id==f._recipes[g].resultants[0].id){f=!0;break a}f=!1}else f=void 0;if(!f){f=new C;for(g=0;g<c.length;g++)f.addIngredient(new A(c[g].Id,c[g].Quantity));for(g=0;g<d.length;g++)f.addResultant(new A(d[g].Id,
...
d/10+"%";a.sidebarProgressText.textContent=Utils.formatTime(c/1E3)}})},10);a.update=function(){f&&(v.forEach(function(a){var b=Objects.getQuantity(a.id);a.row.style.display=-1==b||!a.isItem&&0<b?"none":"";a.ingredients.forEach(function(a){var b=Objects.getQuantity(a.id);a.quantityDiv.style.color=b>=a.quantity?"darkgreen":"darkred"})}),a.processors.forEach(function(a){h(a.id,a.recipeSelector.selectedIndex)}))}})(Crafting||(Crafting={}));
