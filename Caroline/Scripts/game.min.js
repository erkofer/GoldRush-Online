...
(function(a){var n=[],h=function(){return function(){this.quantity=0}}();a.register=function(a,m){if(!n[a]){var l=new h;l.name=m;n[a]=l}};a.lookupName=function(a){return n[a].name};a.setQuantity=function(a,h){n[a].quantity=h};a.getQuantity=function(a){return n[a].quantity};a.setMaxQuantity=function(a,h){n[a].maxQuantity=h};a.getMaxQuantity=function(a){return n[a].maxQuantity};a.setLifeTimeTotal=function(a,h){n[a].lifeTimeTotal=h};a.getLifeTimeTotal=function(a){return n[a].lifeTimeTotal}})(Objects||
(Objects={}));var Account;
...
(function(a){function n(a,b){var c=a.getBoundingClientRect();return{x:b.clientX-c.left,y:b.clientY-c.top}}function h(b,c){if(b>e&&b<e+64&&c>r&&c<r+64){if(w){m(e+2,r+2,60,60);if(v)for(var d=Utils.getRandomInt(1,3),p=0;p<d;p++){var f=Utils.getRandomInt(-5,5),s=Utils.getRandomInt(-2,2);a.particles.push(new z(b+f,c+s))}v=!1}else m(e-2,r-2,68,68),v=!0;t=!0}else t&&(m(e,r,64,64),t=!1,v=!0)}function g(a,b){a!=e&&b!=r&&(e=a,r=b,p?m(a,b,64,64):setTimeout(function(){g(a,b)},10))}function m(a,d,p,e){k.clearRect(0,
0,250,250);k.drawImage(b,0,0);k.drawImage(c,a,d,p,e)}var l=document.getElementById("rock"),f=document.getElementById("particles"),k=l.getContext("2d"),d=f.getContext("2d"),b=new Image,c=new Image(16,16),p=!1,e=0,r=0,t=!1,w=!1;a.particles=[];var z=function(){function a(b,c){this.height=this.width=5;this.dispose=!1;this.x=b;this.y=c;this.verticalVelocity=Utils.getRandomInt(-100,-155);this.horizonalVelocity=Utils.getRandomInt(-50,50);this.width=Utils.getRandomInt(3,6);this.height=Utils.getRandomInt(3,
6);this.rotation=Utils.getRandomInt(0,180);this.rotationalVelocity=Utils.getRandomInt(-75,75);this.lastTick=Date.now()}a.prototype.update=function(){var a=Date.now()-this.lastTick;this.lastTick=Date.now();a/=1E3;this.rotation+=this.rotationalVelocity*a;this.y+=this.verticalVelocity*a;this.x+=this.horizonalVelocity*a;this.verticalVelocity+=200*a;270<this.y&&(this.dispose=!0)};return a}();a.Particle=z;var v=!0;a.moveRock=g;var s=document.createElement("canvas"),y=s.getContext("2d");setInterval(function(){d.clearRect(0,
...
b.src="/Content/Rock.png";c.onload=function(){p=!0};c.src="/Content/Stone.png";l.addEventListener("mousemove",function(a){a=n(l,a);h(a.x,a.y)},!1);l.addEventListener("mousedown",function(a){a=n(l,a);w=!0;h(a.x,a.y);Connection.mine(a.x,a.y)},!1);l.addEventListener("mouseup",function(a){a=n(l,a);w=!1;h(a.x,a.y)},!1);l.addEventListener("mouseleave",function(a){a=n(l,a);w=!1;h(a.x,a.y)},!1)})()})(Rock||(Rock={}));var Tabs;
...
(function(a){function n(a,b){var c=d.getBoundingClientRect(),p=c.right-c.left,c=c.bottom-c.top;d.style.left=p+(a+15)>window.innerWidth?a-p-15+"px":a+15+"px";d.style.top=0<b-c?b-c+"px":b+5+"px"}function h(){d&&d.parentElement.removeChild(d);k=d=null}function g(a,b,c){var d=new t;m(a);c&&(d.header=c);d.content=b;f.push(d);a.dataset?a.dataset.tooltip=l:a.setAttribute("data-tooltip",l.toString());l++}function m(a){a.onmouseenter=function(a){var g=+a.target.getAttribute("data-tooltip");r!==a.target&&(b=
...
"_"));e.appendChild(d);c.appendChild(e);d=document.createElement("DIV");b.quantityElm=d;d.classList.add("item-text");d.textContent=Utils.formatNumber(0);c.appendChild(d);if(null!=b.category){var u,h,e=p.rows.length,d=b.category,d=2*d;d--;for(f=0;f<e;f++){var g=p.rows[f].cells[d];if(g&&0==g.childElementCount){u=p.rows[f].cells[d];h=p.rows[f].cells[d-1];break}}if(!u){h=p.insertRow(p.rows.length);h.classList.add("table-row");for(var k in v)0<=parseInt(k,10)&&"NFS"!=v[k]&&(h.insertCell(h.cells.length).classList.add("config-cell-check"),
...
a.configClickers[l]=u;u.addEventListener("change",function(b){Connection.configureItem(l,a.configClickers[l].checked)});h.appendChild(u)}return c}a.items=[];a.configClickers=[];var f,k,d,b,c,p,e,r,t=[],w=[],z=function(){return function(a,b,c,d){this.id=a;this.name=b;this.worth=c;this.category=d}}();a.Item=z;(function(a){a[a.NFS=0]="NFS";a[a.ORE=1]="ORE";a[a.GEM=2]="GEM";a[a.INGREDIENT=3]="INGREDIENT";a[a.CRAFTING=4]="CRAFTING";a[a.POTION=5]="POTION"})(a.Category||(a.Category={}));var v=a.Category;
...
f.classList.add("item-text");e=document.createElement("div");e.textContent=Utils.formatNumber(a.price);e.style.display="inline-block";e.style.verticalAlign="top";a.priceElm=e;h=document.createElement("div");h.classList.add("Quarter-Coins");h.style.display="inline-block";f.appendChild(h);f.appendChild(e);var e=document.createElement("div"),h=Utils.createButton("Buy",""),l=a.id;if(5!=a.category)h.addEventListener("click",function(){Connection.purchaseItem(l)});else{var m=document.createElement("INPUT");
m.type="TEXT";m.style.width="40px";m.style.height="15px";e.appendChild(m);h.addEventListener("click",function(){Utils.isNumber(m.value)&&Connection.purchaseItem(l,+m.value)})}e.appendChild(h);c.appendChild(e);c.appendChild(f);b.appendChild(c);return b}var g,m=[],l=[];(function(a){a[a.MINING=1]="MINING";a[a.MACHINES=2]="MACHINES";a[a.GATHERING=3]="GATHERING";a[a.PROCESSING=4]="PROCESSING";a[a.ITEMS=5]="ITEMS";a[a.CRAFTING=6]="CRAFTING"})(a.Category||(a.Category={}));var f=a.Category,k=function(){return function(){}}();
a.tempFix=function(){n()};a.addItem=function(a,b,c,p,e,r){g||n();if(!m[a]){Objects.register(a,e);var t=new k;t.id=a;t.category=b;t.price=c;t.factor=p;t.name=e;t.maxQuantity=r?r:0;Objects.register(t.id,t.name);2==t.category&&Equipment.registerGatherer(t.id);b=l[f[b]];null==b&&(b=l.MINING);6!=t.category&&b.appendChild(h(t));m[a]=t}};a.changeQuantity=function(a,b,c,f){var e=m[a];Utils.ifNotDefault(c,function(){if(0!=c)try{e.maxQuantity=c,e.maxQuantityElm.textContent=c.toString()}catch(a){}});Utils.ifNotDefault(b,
function(){Objects.setQuantity(a,b);e.quantity=b;Crafting.update();0!=c&&6!=e.category&&(e.container.style.display=-1>=e.quantity||e.quantity>=e.maxQuantity&&0<e.maxQuantity?"none":"inline-block",e.maxQuantity&&1<e.maxQuantity&&(e.quantityElm.textContent=b.toString()))});Utils.ifNotDefault(f,function(){e.priceElm&&(e.price=f,e.priceElm.textContent=Utils.formatNumber(f))})}})(Store||(Store={}));var Statistics;
...
f;for(var h=0;h<c.length;h++){var g=f.insertCell(0);g.style.width=p[h];"0"!=e[h]&&(g.style.minWidth=e[h]);"Name"==c[h]&&(g.textContent=Objects.lookupName(a.id));if("Input"==c[h])for(var k=0;k<a.ingredients.length;k++){var l=document.createElement("DIV");l.classList.add("item-text");l.style.height="22px";var m=document.createElement("DIV");m.style.display="inline-block";var n=document.createElement("DIV");a.ingredients[k].quantityDiv=n;n.style.display="inline-block";n.style.verticalAlign="super";n.textContent=
Utils.formatNumber(a.ingredients[k].quantity);m.classList.add("Third-"+Utils.cssifyName(Objects.lookupName(a.ingredients[k].id)));l.appendChild(m);l.appendChild(n);g.appendChild(l)}if("Output"==c[h])for(k=0;k<a.resultants.length;k++)l=document.createElement("DIV"),l.classList.add("item-text"),l.style.height="22px",m=document.createElement("DIV"),m.style.display="inline-block",n=document.createElement("DIV"),n.style.display="inline-block",n.style.verticalAlign="super",n.textContent=Utils.formatNumber(a.resultants[k].quantity),
...
g.appendChild(q)}}}var f,k,d,b,c=["Action","Description","Input","Output","Name"],p=["10%","50%","15%","15%","10%"],e=["170px","0","0","0","0"],r=["Action","Output","Input","Capacity","Image"],t=["10%","30%","20%","20%","20%"],w=["170px","0","0","0","0"],z=3,v=[];a.processors=[];var s=document.getElementById("sidebarInformation"),y,q=function(){function a(){this._recipes=[]}a.prototype.addRecipe=function(a){this._recipes.push(a);this.selectedRecipe||(this.selectedRecipe=0)};return a}();a.Processor=
q;var B=function(){function a(){this.ingredients=[];this.resultants=[]}a.prototype.addIngredient=function(a){this.ingredients.push(a)};a.prototype.addResultant=function(a){this.resultants.push(a)};return a}();a.Recipe=B;var A=function(){return function(a,b){this.id=a;this.quantity=b}}();a.Ingredient=A;a.addRecipe=function(a,b,c,d){f||n();if(!v[a]){var e=new B;e.id=a;e.isItem=d;v[a]=e;for(a=0;a<b.length;a++)e.addIngredient(new A(b[a].Id,b[a].Quantity));for(a=0;a<c.length;a++)e.addResultant(new A(c[a].Id,
c[a].Quantity));l(e,d)}};a.addProcessor=function(b,c){f||n();if(!a.processors[b]){var d=new q;d.id=b;d.name=c;a.processors[b]=d;g(d)}};a.addProcessorRecipe=function(b,c,d){if(a.processors[b]){var e=a.processors[b],f;a:if(a.processors[b]){f=a.processors[b];for(var g=0;g<f._recipes.length;g++)if(d[0].Id==f._recipes[g].resultants[0].id){f=!0;break a}f=!1}else f=void 0;if(!f){f=new B;for(g=0;g<c.length;g++)f.addIngredient(new A(c[g].Id,c[g].Quantity));for(g=0;g<d.length;g++)f.addResultant(new A(d[g].Id,
